...
public class DineInEstimationCreation_UnitTest extends BaseClass {
	...
	public DineInEstimationCreation_UnitTest() {
		super();
	}
	...
	@Test
	public void fnVerifyDineInEstimationCreation() {
		GenericMethods.fnStartTestCase("Verify Dine In Estimation and new customer Creation");				
	...
	public void fnVerifyEstimationSavedOrNot() {
		GenericMethods.fnStartTestCase("Verify Dine In Estimation has been successfully saved or not");				
	...
	public void fnVerifyCustomerSavedOrNot() throws IOException {
		...
		RefCustomerMaster.VerifyRuntimeCustomerSavedOrNot(22);
